#ifndef MINI_TABLEGEN_TGPARSER_H
#define MINI_TABLEGEN_TGPARSER_H
...
private: // Parser methods.
  ...
  Init *ParseValue(Record *CurRec, RecTy *ItemType = nullptr,
                   IDParseMode Mode = ParseValueMode);
  void ParseValueList(SmallVectorImpl<mini_tablegen::Init *> &Result,
                      Record *CurRec, RecTy *ItemType = nullptr);
  bool ParseTemplateArgValueList(
      SmallVectorImpl<mini_tablegen::ArgumentInit *> &Result, Record *CurRec,
      Record *ArgsRec);
  void ParseDagArgList(
      SmallVectorImpl<std::pair<mini_tablegen::Init *, StringInit *>> &Result,
      Record *CurRec);
  ...
  bool
  CheckTemplateArgValues(SmallVectorImpl<mini_tablegen::ArgumentInit *> &Values,
                         SMLoc Loc, Record *ArgsRec);
};

} // namespace mini_tablegen

#endif // MINI_TABLEGEN_TGPARSER_H